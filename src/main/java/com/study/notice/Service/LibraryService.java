...
import com.study.notice.repository.AuthorRepository;
import com.study.notice.repository.BookRepository;
import com.study.notice.repository.LendRepository;
import com.study.notice.repository.MemberRepository;
    ...
    public List<String> lendABook (List<BookLendRequest> list) {
        ...
        list.forEach(bookLendRequest -> {
            Optional<Book> bookForId =
                    bookRepository.findById(bookLendRequest.getMemberId());
